...
describe('Publish Artifact task tests', function () {
    ...
    it('it should fail if name is not specified', function (done) {
        this.timeout(1000);
    ...
    it('it should fail if type is not specified', function (done) {
        this.timeout(1000);
    ...
    it('it should fail if incorrect type is specified', function (done) {
        this.timeout(1000);
    ...
    it('it should fail if groupId is not specified for the Java type', function (done) {
        this.timeout(1000);
    ...
    it('it should fail if artifactId is not specified for the Java type', function (done) {
        this.timeout(1000);
    ...
    it('it should fail if version is not specified for the Java type', function (done) {
        this.timeout(1000);
    ...
    it('it should fail if version is not specified', function (done) {
        this.timeout(1000);
