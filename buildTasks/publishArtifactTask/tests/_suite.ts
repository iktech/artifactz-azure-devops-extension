...
describe('Publish Artifact task tests', function () {
    ...
    it('it should fail if name is not specified', async () => {
    ...
    it('it should fail if incorrect type is specified', async () => {
    ...
    it('it should fail if groupId is not specified for the Java type', async () => {
    ...
    it('it should fail if artifactId is not specified for the Java type', async () => {
    ...
    it('it should fail if version is not specified for the Java type', async () => {
    ...
    it('it should fail if version is not specified', async () => {
